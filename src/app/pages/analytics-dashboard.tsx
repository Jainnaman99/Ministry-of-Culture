...
export function AnalyticsDashboard() {
  ...
  const statsData = {
    today: [
      ...
      { title: "RAG Accuracy", value: "96.3%", change: "+1.1%", up: true, icon: Shield, subtitle: "sample verified" },
    ...
    week: [
      ...
      { title: "RAG Accuracy", value: "95.8%", change: "+0.7%", up: true, icon: Shield, subtitle: "sample verified" },
    ...
    month: [
      ...
      { title: "RAG Accuracy", value: "96.1%", change: "+2.1%", up: true, icon: Shield, subtitle: "sample verified" },
